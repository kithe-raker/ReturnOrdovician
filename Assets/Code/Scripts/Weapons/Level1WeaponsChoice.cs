...
//place this prefab at the middle of door of level1 to level2. warning there are 3 doors //-15.94   -0.683    35.183
    ...
    public void spawnItem(){
        ...
        Instantiate(item[0], point[2].position, transform.rotation);
        Instantiate(item[1], point[1].position, transform.rotation);
        Instantiate(item[1], point[3].position, transform.rotation);
       
       

        FindWeapon[0] = GameObject.Find("Pickup_PlasmaticSMG(Clone)");
        FindWeapon[0].name = "Pickup_PlasmaticSMG(Clone)0";
        FindWeapon[1] = GameObject.Find("Pickup_PlasmaticSMG(Clone)");
    ...
    void Update()
    {
        ...
        if((FindWeapon[0]==null||FindWeapon[1]==null||FindWeapon[2]==null||FindWeapon[3]==null)&&once==2){
            for(int i = 0;i<4;i++){
